...
pub struct AddVideoPlaylistVideoRequest {
    #[serde(rename = "videoId")]
    pub video_id: Box<models::AddVideoPlaylistVideoRequestVideoId>,
...
impl AddVideoPlaylistVideoRequest {
    pub fn new(video_id: models::AddVideoPlaylistVideoRequestVideoId) -> AddVideoPlaylistVideoRequest {
