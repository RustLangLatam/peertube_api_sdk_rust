...
pub struct LiveVideoSessionResponse {
    ...
    pub error: Option<Option<Error>>,
    #[serde(rename = "replayVideo", skip_serializing_if = "Option::is_none")]
    pub replay_video: Option<Box<models::LiveVideoSessionResponseReplayVideo>>,
}

impl LiveVideoSessionResponse {
    pub fn new() -> LiveVideoSessionResponse {
