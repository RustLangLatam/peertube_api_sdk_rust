...
/// VideoResolutionConstant : resolutions and their labels for the video
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct VideoResolutionConstant {
...
impl VideoResolutionConstant {
    /// resolutions and their labels for the video
    pub fn new() -> VideoResolutionConstant {
