...
pub struct VideoFile {
    ...
    pub resolution: Option<Box<models::VideoResolutionConstant>>,
    ...
    #[serde(rename = "torrentDownloadUrl", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "fileDownloadUrl", skip_serializing_if = "Option::is_none")]
    ...
    pub storage: Option<models::FileStorage>,
}
