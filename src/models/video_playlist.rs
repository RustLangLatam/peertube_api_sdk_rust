...
pub struct VideoPlaylist {
    ...
    #[serde(rename = "videoLength", skip_serializing_if = "Option::is_none")]
    pub video_length: Option<i32>,
    #[serde(rename = "thumbnailPath", skip_serializing_if = "Option::is_none")]
    pub thumbnail_path: Option<String>,
    #[serde(rename = "privacy", skip_serializing_if = "Option::is_none")]
    pub privacy: Option<Box<models::VideoPlaylistPrivacyConstant>>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<Box<models::VideoPlaylistTypeConstant>>,
    #[serde(rename = "ownerAccount", skip_serializing_if = "Option::is_none")]
    pub owner_account: Option<Box<models::AccountSummary>>,
    #[serde(rename = "videoChannel", skip_serializing_if = "Option::is_none")]
    pub video_channel: Option<Box<models::VideoChannelSummary>>,
}

impl VideoPlaylist {
    pub fn new() -> VideoPlaylist {
        VideoPlaylist {
            id: None,
            uuid: None,
            short_uuid: None,
