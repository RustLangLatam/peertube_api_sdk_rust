...
pub struct UpdateMe {
    ...
    #[serde(rename = "displayNSFW", skip_serializing_if = "Option::is_none")]
    pub display_nsfw: Option<DisplayNsfw>,
    ...
    #[serde(rename = "videosHistoryEnabled", skip_serializing_if = "Option::is_none")]
    pub videos_history_enabled: Option<bool>,
    /// list of languages to filter videos down to
    #[serde(rename = "videoLanguages", skip_serializing_if = "Option::is_none")]
    pub video_languages: Option<Vec<String>>,
...
impl Default for DisplayNsfw {
    fn default() -> DisplayNsfw {
        Self::True
    }
}
