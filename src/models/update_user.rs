...
pub struct UpdateUser {
    ...
    #[serde(rename = "pluginAuth", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub plugin_auth: Option<Option<String>>,
    #[serde(rename = "role", skip_serializing_if = "Option::is_none")]
    pub role: Option<models::UserRole>,
    #[serde(rename = "adminFlags", skip_serializing_if = "Option::is_none")]
    pub admin_flags: Option<models::UserAdminFlags>,
