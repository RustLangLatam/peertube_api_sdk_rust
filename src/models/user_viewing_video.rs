...
pub struct UserViewingVideo {
    /// timestamp within the video, in seconds
    #[serde(rename = "currentTime")]
    pub current_time: i32,
    /// Event since last viewing call:  * `seek` - If the user seeked the video 
    #[serde(rename = "viewEvent", skip_serializing_if = "Option::is_none")]
    pub view_event: Option<ViewEvent>,
...
impl UserViewingVideo {
    pub fn new(current_time: i32) -> UserViewingVideo {
        UserViewingVideo {
            current_time,
            view_event: None,
            session_id: None,
...
impl Default for ViewEvent {
    fn default() -> ViewEvent {
        Self::Seek
    }
}
