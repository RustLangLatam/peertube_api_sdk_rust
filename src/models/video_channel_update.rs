...
pub struct VideoChannelUpdate {
    ...
    #[serde(rename = "bulkVideosSupportUpdate", skip_serializing_if = "Option::is_none")]
    pub bulk_videos_support_update: Option<bool>,
}

impl VideoChannelUpdate {
    pub fn new() -> VideoChannelUpdate {
        VideoChannelUpdate {
            display_name: None,
            description: None,
            support: None,
            bulk_videos_support_update: None,
        }
    }
}
