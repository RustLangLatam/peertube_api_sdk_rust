...
pub struct VideoUploadRequestResumable {
    /// Video name
    #[serde(rename = "name")]
    pub name: String,
    ...
    pub privacy: Option<models::VideoPrivacySet>,
    ...
    #[serde(rename = "waitTranscoding", skip_serializing_if = "Option::is_none")]
    pub wait_transcoding: Option<bool>,
    /// **PeerTube >= 6.2** If enabled by the admin, automatically generate a subtitle of the video
    #[serde(rename = "generateTranscription", skip_serializing_if = "Option::is_none")]
    pub generate_transcription: Option<bool>,
    ...
    #[serde(rename = "commentsPolicy", skip_serializing_if = "Option::is_none")]
    pub comments_policy: Option<models::VideoCommentsPolicySet>,
    /// Enable or disable downloading for this video
    #[serde(rename = "downloadEnabled", skip_serializing_if = "Option::is_none")]
    pub download_enabled: Option<bool>,
    /// Date when the content was originally published
    #[serde(rename = "originallyPublishedAt", skip_serializing_if = "Option::is_none")]
    pub originally_published_at: Option<String>,
    #[serde(rename = "scheduleUpdate", skip_serializing_if = "Option::is_none")]
    pub schedule_update: Option<Box<models::VideoScheduledUpdate>>,
    /// Video thumbnail file
    #[serde(rename = "thumbnailfile", skip_serializing_if = "Option::is_none")]
    pub thumbnailfile: Option<std::path::PathBuf>,
    /// Video preview file
    #[serde(rename = "previewfile", skip_serializing_if = "Option::is_none")]
    pub previewfile: Option<std::path::PathBuf>,
    #[serde(rename = "videoPasswords", skip_serializing_if = "Option::is_none")]
    pub video_passwords: Option<Vec<String>>,
    /// Video filename including extension
    #[serde(rename = "filename")]
    pub filename: String,
}

impl VideoUploadRequestResumable {
    pub fn new(name: String, channel_id: i32, filename: String) -> VideoUploadRequestResumable {
