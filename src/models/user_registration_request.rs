...
pub struct UserRegistrationRequest {
    ...
    pub channel: Option<Box<models::RegisterUserChannel>>,
    /// reason for the user to register on the instance
    #[serde(rename = "registrationReason")]
    pub registration_reason: String,
}

impl UserRegistrationRequest {
    pub fn new(username: String, password: String, email: String, registration_reason: String) -> UserRegistrationRequest {
