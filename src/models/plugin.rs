...
pub struct Plugin {
    ...
    #[serde(rename = "uninstalled", skip_serializing_if = "Option::is_none")]
    pub uninstalled: Option<bool>,
    #[serde(rename = "peertubeEngine", skip_serializing_if = "Option::is_none")]
    pub peertube_engine: Option<String>,
