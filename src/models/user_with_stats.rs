...
pub struct UserWithStats {
    ...
    #[serde(rename = "abusesCount", skip_serializing_if = "Option::is_none")]
    pub abuses_count: Option<i32>,
    /// Count of reports/abuses created by the user and accepted/acted upon by the moderation team
    #[serde(rename = "abusesAcceptedCount", skip_serializing_if = "Option::is_none")]
    pub abuses_accepted_count: Option<i32>,
    /// Count of reports/abuses created by the user
    #[serde(rename = "abusesCreatedCount", skip_serializing_if = "Option::is_none")]
    pub abuses_created_count: Option<i32>,
    /// Count of comments published
    #[serde(rename = "videoCommentsCount", skip_serializing_if = "Option::is_none")]
    pub video_comments_count: Option<i32>,
}

impl UserWithStats {
    pub fn new() -> UserWithStats {
        UserWithStats {
            account: None,
            ...
            videos_count: None,
            abuses_count: None,
            abuses_accepted_count: None,
            abuses_created_count: None,
