...
pub struct VideoDetails {
    ...
    pub channel: Option<Box<models::VideoChannel>>,
    ...
    pub comments_policy: Option<Box<models::VideoCommentsPolicyConstant>>,
    ...
    #[serde(rename = "inputFileUpdatedAt", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub input_file_updated_at: Option<Option<String>>,
    #[serde(rename = "trackerUrls", skip_serializing_if = "Option::is_none")]
    ...
    pub files: Option<Vec<models::VideoFile>>,
    ...
    #[serde(rename = "streamingPlaylists", skip_serializing_if = "Option::is_none")]
    pub streaming_playlists: Option<Vec<models::VideoStreamingPlaylists>>,
}
...
impl VideoDetails {
    pub fn new() -> VideoDetails {
        VideoDetails {
            ...
            input_file_updated_at: None,
            tracker_urls: None,
            files: None,
            streaming_playlists: None,
        }
    }
}
