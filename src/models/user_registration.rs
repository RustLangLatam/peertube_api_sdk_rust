...
pub struct UserRegistration {
    ...
    pub state: Option<Box<models::UserRegistrationState>>,
    #[serde(rename = "registrationReason", skip_serializing_if = "Option::is_none")]
    pub registration_reason: Option<String>,
    #[serde(rename = "moderationResponse", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub moderation_response: Option<Option<String>>,
    ...
    #[serde(rename = "channelDisplayName", skip_serializing_if = "Option::is_none")]
    ...
    pub user: Option<Option<Box<models::UserRegistrationUser>>>,
}
