...
pub async fn api_v1_users_me_subscriptions_exist_get(configuration: &configuration::Configuration, uris: Vec<String>) -> Result<serde_json::Value, Error<ApiV1UsersMeSubscriptionsExistGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/users/me/subscriptions/exist", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    local_var_req_builder = match "multi" {
        "multi" => local_var_req_builder.query(&uris.into_iter().map(|p| ("uris".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => local_var_req_builder.query(&[("uris", &uris.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiV1UsersMeSubscriptionsExistGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn api_v1_users_me_subscriptions_get(configuration: &configuration::Configuration, start: Option<i32>, count: Option<i32>, sort: Option<&str>) -> Result<models::VideoChannelList, Error<ApiV1UsersMeSubscriptionsGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/users/me/subscriptions", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiV1UsersMeSubscriptionsGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn api_v1_users_me_subscriptions_post(configuration: &configuration::Configuration, api_v1_users_me_subscriptions_post_request: Option<models::ApiV1UsersMeSubscriptionsPostRequest>) -> Result<(), Error<ApiV1UsersMeSubscriptionsPostError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&api_v1_users_me_subscriptions_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiV1UsersMeSubscriptionsPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn api_v1_users_me_subscriptions_subscription_handle_delete(configuration: &configuration::Configuration, subscription_handle: &str) -> Result<(), Error<ApiV1UsersMeSubscriptionsSubscriptionHandleDeleteError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/users/me/subscriptions/{subscriptionHandle}", local_var_configuration.base_path, subscriptionHandle=crate::apis::urlencode(subscription_handle));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiV1UsersMeSubscriptionsSubscriptionHandleDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn api_v1_users_me_subscriptions_subscription_handle_get(configuration: &configuration::Configuration, subscription_handle: &str) -> Result<models::VideoChannel, Error<ApiV1UsersMeSubscriptionsSubscriptionHandleGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiV1UsersMeSubscriptionsSubscriptionHandleGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn api_v1_users_me_subscriptions_videos_get(configuration: &configuration::Configuration, category_one_of: Option<models::GetAccountVideosCategoryOneOfParameter>, is_live: Option<bool>, tags_one_of: Option<models::GetAccountVideosTagsOneOfParameter>, tags_all_of: Option<models::GetAccountVideosTagsAllOfParameter>, licence_one_of: Option<models::GetAccountVideosLicenceOneOfParameter>, language_one_of: Option<models::GetAccountVideosLanguageOneOfParameter>, auto_tag_one_of: Option<models::GetAccountVideosTagsAllOfParameter>, nsfw: Option<&str>, is_local: Option<bool>, include: Option<i32>, privacy_one_of: Option<models::VideoPrivacySet>, has_hls_files: Option<bool>, has_web_video_files: Option<bool>, skip_count: Option<&str>, start: Option<i32>, count: Option<i32>, sort: Option<&str>, exclude_already_watched: Option<bool>, search: Option<&str>) -> Result<models::VideoListResponse, Error<ApiV1UsersMeSubscriptionsVideosGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiV1UsersMeSubscriptionsVideosGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
